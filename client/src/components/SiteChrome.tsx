  ...
  return (
    <header className="site-header">
      <div className="header-pill">
        <Link href="/" className="brand" aria-label="copyspheretx home">
        ...
        <div className="header-actions">
          <GoogleTranslate />
          <a className="header-login" href="https://app.copyspheretx.com">Log in</a>
          <a className="button button-dark header-cta" href="https://app.copyspheretx.com">Get started <ArrowUpRight size={15} /></a>
        </div>
      ...
      {open && <div className="mobile-nav">
        ...
        <a href="https://app.copyspheretx.com">Log in</a>
        <a className="button button-dark" href="https://app.copyspheretx.com">Get started <ArrowUpRight size={15} /></a>
      </div>}
    </header>
  );
}
...
export function SiteFooter() {
  return <footer className="site-footer">
    <div className="footer-top">
      <Link href="/" className="brand footer-brand"><span className="leaf-mark" aria-hidden="true"><svg viewBox="0 0 28 28"><path d="M24 4C13 4 5 8 4 21c7 1 14-2 17-8 2-4 3-7 3-9Z" /><path d="M4 21c5-5 10-8 16-11" /></svg></span><span>copyspheretx</span></Link>
      <div className="footer-cta"><p>Make your next move<br /><em>deliberate.</em></p><a className="button button-sand" href="https://app.copyspheretx.com">Open your account <ArrowUpRight size={16} /></a></div>
    </div>
    <div className="footer-columns"><div><small>Explore</small><Link href="/market">Markets</Link><Link href="/approach">Our approach</Link><Link href="/about">About copyspheretx</Link></div><div><small>Resources</small><Link href="/market">Stock research</Link><Link href="/approach">Investment education</Link><a href="mailto:support@copyspheretx.com">Support</a></div><div><small>Follow along</small><div className="footer-socials"><a href="https://x.com" aria-label="X">𝕏</a><a href="https://tiktok.com" aria-label="TikTok">♪</a><a href="https://facebook.com" aria-label="Facebook">f</a></div></div></div>
...
<p className="footer-disclaimer">
  <strong>Terms &amp; Conditions:</strong> Your access to and use of this website and its services are subject to our Terms &amp; Conditions. By using the website, you acknowledge and agree to the applicable terms, policies, disclosures, and requirements.
    ...
    <div className="footer-bottom"><span>© 2026 copyspheretx</span><a href="mailto:support@copyspheretx.com">support@copyspheretx.com</a><span><a href="#privacy">Privacy</a> · <a href="#cookies">Cookies</a> · <a href="#terms">Terms</a></span></div>
  </footer>;
}
