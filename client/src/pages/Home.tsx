...
export default function Home() {
  return <div className="site-shell"><SiteHeader />
    <main>
      ...
      <section className="feature-section section-pad"><div className="container feature-grid"><div className="feature-copy"><p className="eyebrow"><span className="eyebrow-dot" /> The robincorehood difference</p><h2>Grow with a plan<br /><em>you can believe in.</em></h2><p>We pair globally diversified portfolios with a calm, human perspective. No noise. No mystery. Just a clear system built around your ambitions.</p><div className="feature-list"><div><ShieldCheck size={20} /><span><strong>Built to last</strong> Strategies designed for decades, not headlines.</span></div><div><LineChart size={20} /><span><strong>Clear by default</strong> See what you own, why you own it, and what it costs.</span></div><div><Leaf size={20} /><span><strong>Considered impact</strong> Your money can compound with purpose.</span></div></div><Link className="text-link" href="/market">View our investment universe <ChevronRight size={16} /></Link></div><div className="feature-visual"><img src={growth} alt="New growth emerging from a forest floor" /><div className="visual-card"><span>Growth mindset</span><strong>Patient capital<br />creates options.</strong><small>01 — robincorehood Research</small></div></div></div></section>
      ...
      <HomeCollage />
      <MobileInvesting />
      <section className="people-section section-pad container"><div className="people-copy"><div className="section-kicker"><span>05 / The human layer</span><span className="line" /></div><h2>Smart money.<br /><em>Human touch.</em></h2><p>Your life is not a spreadsheet. Our team is here to translate the markets, pressure-test your plan, and make the next step feel simple.</p><Link className="text-link" href="/about">Meet the people behind the plan <ChevronRight size={16} /></Link></div><div className="people-portrait"><img src={advisor} alt="robincorehood investment advisor" /><div className="portrait-label"><span>Olivia Mensah</span><small>Wealth strategist</small></div></div></section>
      <TrustSection />
